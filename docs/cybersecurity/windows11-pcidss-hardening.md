...
description: Rapid PCI-DSS Windows hardening case for Security Compliance/Endpoint roles with evidence pack and controls mapping.
---
...
**Target roles:** Security Compliance Analyst/Engineer, Endpoint Security Engineer (Compliance).
