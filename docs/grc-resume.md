...
## Projects (selected)
- **GIAP™ – Governed Intake and Analysis Platform:** Production GRC platform with CISO Assistant + n8n + Nextcloud + SuiteCRM. 100+ frameworks, HMAC-authenticated webhooks, rate limiting, IP audit logging. End-to-end intake automation with evidence pipelines.
...
## Keywords / Tools
CIS, NIST 800-53, SOC 2; S3 PAB/SSE, GuardDuty, IAM LP; TLS/HSTS; evidence pipelines; Nextcloud, n8n, SuiteCRM; Security Onion, TheHive/Cortex; Python, systemd/cron; GitHub Actions CI; multi-agent LLM workflows.
