---
description: "Pharns Genece — Full Resume. GRC Engineer, Cloud Security, Detection Engineering, RF/SDR Security."
hide:
  - navigation
  - toc
---
...
**Active (14):** Security+ · Network+ · A+ · Project+ · SSCP (Assoc.) · ITIL 4 · LPI Linux Essentials · CSIS · CIOS · CySA+ · CSAP · PenTest+ · CNSP · CNVP
...
**Detection & IR Lab**
Security Onion SIEM, TheHive/Cortex. 12 custom Sigma rules (~20% FP reduction), 8 IR playbooks.

**AgenticOS** *(Open Source)*
Deterministic AI orchestration with audit-grade logging. 6,361 lines Python. github.com/Pharns/AgenticOS
...
<small>To save as PDF: Press Ctrl+P (Cmd+P on Mac) → Save as PDF</small>

[← Back to Resume](resume.md){ .md-button } [Contact Me](contact.md){ .md-button .md-button--primary }
</div>
